...
class DraggableHome extends StatefulWidget {
  ...
  /// Leading Width: The width of the leading widget. The default value is 56.0.
  ...
  /// Header Expanded Height : Height of the header widget.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: NotificationListener<ScrollNotification>(
        ...
        child: sliver(context, appBarHeight, MediaQuery.of(context).size.height,
